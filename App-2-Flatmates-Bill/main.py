...
class Bill:
    """
    Objects that contains that about bill, such as total amount and period of the bill
    """
...
class PdfReport:
    """
    Creates a PDF file that contains data about the flatmates such as their names, their due amount and the
    period of the bill
    """
